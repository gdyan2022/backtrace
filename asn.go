...
var (
	ips = []string{"58.32.16.1", "218.80.64.1", "222.72.161.1", "219.141.136.12", "202.106.50.1", "221.179.155.161", "202.96.209.133", "223.167.244.1",
		"211.136.112.200", "58.60.188.222", "210.21.196.6", "120.196.165.24", "61.139.2.69", "119.6.6.6",
		"211.137.96.205"}
	names = []string{"上海 CN2", "上海电信218", "电信Office", "北京电信", "北京联通", "北京移动", "上海电信", "上海联通", "上海移动", "广州电信", "广州联通", "广州移动",
		"成都电信", "成都联通", "成都移动"}
